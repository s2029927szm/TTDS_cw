...
import linecache
import math
f2=open('C:\\search_cw\\weight222.csv','a',encoding='utf-8')#real one,222 also test one
def getline1 (num):
    return (linecache.getline('C:\\search_cw\\tfnew22.csv',num))
    
def getidft (word):
    idft=0.0
    f1=open('C:\\search_cw\\idft_list22.csv','r',encoding='utf-8')
