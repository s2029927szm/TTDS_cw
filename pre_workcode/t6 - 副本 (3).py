...
import linecache
import math
f2=open('C:\\search_cw\\weight333.csv','a',encoding='utf-8')
def getline1 (num):
    return (linecache.getline('C:\\search_cw\\tfnew33.csv',num))
    
def getidft (word):
    idft=0.0
    f1=open('C:\\search_cw\\idft_list33.csv','r',encoding='utf-8')
